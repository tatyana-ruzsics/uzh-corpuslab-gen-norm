...
Usage:
  vocab_builder.py build [--input_col=COL] [--segments] [--vocab_trunk=VOCAB_TRUNK] [--lowercase=LOW] [--over_words]
...
Options:
  ...
  --over_words                  build vocabulary over words and not chars
 """
...
if __name__ == "__main__":
    ...
    if arguments['build']:
        ...
        build_vocabulary(data,vocab_path, float(arguments['--vocab_trunk']), arguments['--over_words'])
