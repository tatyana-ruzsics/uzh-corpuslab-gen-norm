...
Usage:
  norm_soft_pos.py train [--dynet-seed SEED] [--dynet-mem MEM] [--input_format=INPUT_FORMAT]  [--lowercase=LOW] [--pos_split_space] [--conll_format]
  ...
  norm_soft_pos.py test [--dynet-mem MEM] [--beam=BEAM] [--pred_path=PRED_FILE] [--input_format=INPUT_FORMAT]
    MODEL_FOLDER --test_path=TEST_FILE [--lowercase=LOW] [--pos_split_space] [--conll_format]
  norm_soft_pos.py ensemble_test [--dynet-mem MEM] [--beam=BEAM] [--pred_path=PRED_FILE] [--input_format=INPUT_FORMAT]
    ED_MODEL_FOLDER MODEL_FOLDER --test_path=TEST_FILE [--lowercase=LOW] [--pos_split_space] [--conll_format]
...
def load_data_pos(filename, input_format, lowercase=False, split_by_space=False, conll_format=False):
    """ Load data from file
...
#                if loss is not None:
        ...
        data_set = SoftDataSetFeat
        input_format = [int(col) for col in arguments['--input_format'].split(',')]
        test_data = data_set.from_file(test_path,input_format, arguments['--lowercase'], arguments['--pos_split_space'], arguments['--conll_format'])
